...
if __name__ == "__main__":
    ...
    while count < (end_point+1) :
        ...
        #end of if-else
        html = extract(us)
        if (html.find('alert') > 0 or html.find('15MAT31')< 0) :
                count+=1
    ...
    #headers are removed
                ...
                if dip_flag == 0:
                  ...
                  if header1[0] == '15MATDIP31':   #if its not a dip student
                    for j in range (0,4):
                      htmlc1 += """<td> - </td>"""
    ...
    html += """ <th scope="col"> %s </th>""" %marks_list[0]
